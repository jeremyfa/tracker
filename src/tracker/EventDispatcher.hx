...
/// On
    ...
    public function wrapOn(index:Int):Dynamic {
        ...
        if (wrapped == null) {
            wrapped = function(#if tracker_optional_owner ?owner:Dynamic #else owner:Dynamic #end, ?cb:Dynamic) {
    ...
    public function on(index:Int, #if tracker_optional_owner ?owner:Entity #else owner:Entity #end, cb:Dynamic):Void {
...
/// Once
    ...
    public function once(index:Int, #if tracker_optional_owner ?owner:Entity #else owner:Entity #end, cb:Dynamic):Void {
